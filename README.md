...
General Data Protection Regulations (GDPR) EU - When storing data, there are some EU GDPR regulations that must be adhered to. Here are some of the key principles that Paws & Whiskers will be expected to demonstrate knowledge and adherence to: 
...
**Data Protection Act (DPA) UK** – In addition to the EU GDPR laws, there are also additional UK specific laws introduced by the DPA that PAws & Whiskers will need to be aware of and follow:  
...
**Payment Card Industry Data Security Standard (PCI DSS):** This standard applies to any business that handles credit card information. It sets requirements for securing cardholder data, including encryption, access controls, and regular security testing.
